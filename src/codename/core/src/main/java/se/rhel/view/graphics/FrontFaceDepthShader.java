...
public class FrontFaceDepthShader extends DefaultShader {
	...
	public final static String getDefaultVertexShader() {
		if (defaultVertexShader == null)
			defaultVertexShader = Gdx.files.internal("shader/depth.vertex.glsl").readString();
	...
	public final static String getDefaultFragmentShader() {
		if (defaultFragmentShader == null)
			defaultFragmentShader = Gdx.files.internal("shader/depth.fragment.glsl").readString();
